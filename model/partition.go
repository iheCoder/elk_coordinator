...
type PartitionInfo struct {
	...
	LastHeartbeat time.Time              `json:"last_heartbeat,omitempty"` // Consider if this is still needed if UpdatedAt is used for staleness
...
type GetPartitionsFilters struct {
	...
	// IncludeArchived 是否包含已完成分区（从 Archive Layer 查询）
